...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .app-root {
        /* Palette matched to the logo: deep burgundy + warm gold on cream,
           with peacock-inspired burgundy standing in for the old magenta accent. */
        --ivory: #FBF6EA;
        --surface: #FFFFFF;
        --wine: #8A1F38;
        --wine-dark: #4A1220;
        ...
        background-image:
          url("data:image/svg+xml;base64,"),
          radial-gradient(ellipse at top, #F6EDD8 0%, var(--ivory) 65%);
