...
const ABOUT_PARAGRAPHS = [
  "MarriHeaven is a dedicated wedding event organizing company committed to turning your dream wedding into reality. We work closely with couples and families to plan, coordinate, and execute weddings across indoor banquet halls, outdoor lawns, and beach destinations.",
...
const INTRO_PARAGRAPHS = [
  "Finding the perfect venue and experiencing your wedding exactly as you imagined it — that's what we're here for. We help you discover beautiful indoor, outdoor, and beachside venues, each handpicked to reflect a different kind of celebration.",
...
const PROCESS_STEPS = [
  ...
  { icon: MapPinned, title: "Explore Curated Venues", description: "Browse indoor, outdoor, and beach venues that fit your vision." },
...
const FAQS = [
  {
    ...
    answer: "Yes — Indoor, Outdoor, and Beach are our most requested styles, but our team can help you find or arrange other types of venues as well. Just reach out with what you have in mind.",
  },
  {
...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .app-root {
        /* Deep, rich dark-maroon theme — variable names kept for consistency
           with the rest of the file, but the values below define a dark palette. */
        --ivory: #2B131D;
        --surface: #3D1F2E;
        --wine: #E8608F;
        --wine-dark: #E8C687;
        ...
        --charcoal: #F3E9E2;
        --muted: #C9AFA0;
        --border: rgba(217, 168, 85, 0.28);

        font-family: 'Jost', sans-serif;
        background: radial-gradient(ellipse at top, #3E1F2E 0%, var(--ivory) 62%);
        color: var(--charcoal);
        min-height: 100vh;
      }
      ...
      .brand-name {
        ...
        letter-spacing: 2px; color: var(--wine-dark);
      }
      ...
      .hero-overlay h1 {
        font-family: 'Cormorant Garamond', serif; font-size: 44px; color: #fff;
      ...
      .process-section h2 { font-family: 'Cormorant Garamond', serif; font-size: 26px; color: var(--wine-dark); }
      ...
      .faq-section h2 { font-family: 'Cormorant Garamond', serif; font-size: 26px; color: var(--wine-dark); }
      ...
      /* footer */
      .site-footer {
        border-top: 3px double var(--gold); padding: 30px 24px 40px; text-align: center;
      ...
      .venue-price-line {
        display: inline-block; background: var(--gold-light); color: var(--ivory);
