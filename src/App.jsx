...
function Header({ view, goHome, goAbout, goContact }) {
  return (
    <header className="site-header">
      <MandalaMotif className="header-mandala" />
...
function MandalaMotif(props) {
  const outerAngles = Array.from({ length: 16 }, (_, i) => i * (360 / 16));
  const dotAngles = Array.from({ length: 24 }, (_, i) => i * (360 / 24));
  const innerAngles = Array.from({ length: 8 }, (_, i) => i * (360 / 8));
  return (
    <svg {...props} viewBox="0 0 420 420" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <g transform="translate(210,210)">
        <circle r="190" stroke="currentColor" strokeWidth="1" />
        <circle r="150" stroke="currentColor" strokeWidth="1" />
        <g stroke="currentColor" strokeWidth="1">
          {outerAngles.map((a) => (
            <g key={a} transform={`rotate(${a})`}>
              <path d="M0,-180 C14,-145 14,-120 0,-105 C-14,-120 -14,-145 0,-180 Z" />
            </g>
          ))}
        </g>
        <circle r="120" stroke="currentColor" strokeWidth="1" />
        <g fill="currentColor">
          {dotAngles.map((a) => (
            <g key={a} transform={`rotate(${a})`}>
        ...
        <circle r="80" stroke="currentColor" strokeWidth="1" />
        <g stroke="currentColor" strokeWidth="1">
          {innerAngles.map((a) => (
            <g key={a} transform={`rotate(${a})`}>
              <path d="M0,-70 C10,-50 10,-35 0,-25 C-10,-35 -10,-50 0,-70 Z" />
            </g>
          ))}
        </g>
        <circle r="40" stroke="currentColor" strokeWidth="1" />
...
function PeacockFeatherMotif(props) {
  return (
    <svg {...props} viewBox="0 0 160 220" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M80 10 C20 55 15 130 80 210 C145 130 140 55 80 10 Z" stroke="currentColor" strokeWidth="2" />
      <ellipse cx="80" cy="80" rx="30" ry="42" stroke="currentColor" strokeWidth="2" />
      <ellipse cx="80" cy="80" rx="16" ry="24" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="80" cy="80" r="6" fill="currentColor" />
      <line x1="80" y1="122" x2="80" y2="205" stroke="currentColor" strokeWidth="2" />
    </svg>
  );
}

function LotusMotif(props) {
  return (
    <svg {...props} viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <g stroke="currentColor" strokeWidth="1.5">
        <path d="M100 130 C70 100 60 60 100 20 C140 60 130 100 100 130 Z" />
        <path d="M100 130 C60 110 35 75 55 30 C95 45 110 90 100 130 Z" />
        <path d="M100 130 C140 110 165 75 145 30 C105 45 90 90 100 130 Z" />
        <path d="M100 130 C50 122 15 100 20 65 C65 60 100 90 100 130 Z" />
        <path d="M100 130 C150 122 185 100 180 65 C135 60 100 90 100 130 Z" />
      </g>
      <line x1="30" y1="130" x2="170" y2="130" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}

function PeacockIllustration(props) {
  const feathers = [-55, -33, -11, 11, 33, 55];
  return (
    <svg {...props} viewBox="0 0 400 380" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <g transform="translate(170,300)">
        {feathers.map((a, i) => (
          <g key={i} transform={`rotate(${a})`}>
            <path d="M0,0 C-20,-75 -16,-135 0,-175 C16,-135 20,-75 0,0 Z" fill="none" stroke="#B8935A" strokeWidth="2" />
            <ellipse cx="0" cy="-145" rx="11" ry="17" fill="#8A1F38" />
            <ellipse cx="0" cy="-145" rx="5" ry="8" fill="#F3E2C4" />
          </g>
        ))}
      </g>
      <ellipse cx="170" cy="300" rx="28" ry="40" fill="#4A1220" />
      <path d="M158,268 C148,215 154,165 186,132" stroke="#4A1220" strokeWidth="15" fill="none" strokeLinecap="round" />
      <circle cx="193" cy="120" r="15" fill="#4A1220" />
      <path d="M193,105 L188,86 M197,104 L202,84 M193,103 L193,82" stroke="#B8935A" strokeWidth="2.5" strokeLinecap="round" />
    </svg>
  );
}

function ArchMotif(props) {
  return (
    <svg {...props} viewBox="0 0 300 400" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path d="M40,400 L40,160 C40,80 90,30 150,30 C210,30 260,80 260,160 L260,400" stroke="currentColor" strokeWidth="3" />
      <path d="M65,400 L65,165 C65,100 100,55 150,55 C200,55 235,100 235,165 L235,400" stroke="currentColor" strokeWidth="1.5" />
      <path d="M150,30 L150,8" stroke="currentColor" strokeWidth="2" />
      <path d="M128,14 L172,14" stroke="currentColor" strokeWidth="2" />
      <circle cx="150" cy="8" r="4" fill="currentColor" />
    </svg>
  );
}
  ...
  return (
    <div className="section-band-outer">
      ...
      <div className="quote-feature-band">
        <MandalaMotif className="quote-feature-mandala" />
...
function SectionBand({ color, motif, motifSide, motifTone, children }) {
  const toneClass = "band-motif-tone-" + (motifTone || "gold");
  return (
    <div className="section-band-outer">
      <WaveTop color={color} />
      <div className="section-band" style={{ backgroundColor: color }}>
        {motif === "mandala" && <MandalaMotif className={"band-motif band-motif-mandala " + toneClass + " band-motif-" + (motifSide || "right")} />}
        {motif === "feather" && <PeacockFeatherMotif className={"band-motif " + toneClass + " band-motif-" + (motifSide || "right")} />}
        {motif === "lotus" && <LotusMotif className={"band-motif band-motif-lotus " + toneClass + " band-motif-" + (motifSide || "right")} />}
...
function HomePage({ goToCategory }) {
  ...
  return (
    <div className="page home-page">
      ...
      <SectionBand color="var(--band-gold)" motif="mandala" motifSide="right" motifTone="wine">
        <ValueProps />
      </SectionBand>
      ...
      <SectionBand color="var(--band-blush)" motif="mandala" motifSide="left" motifTone="gold">
      ...
      <section className="services-section" id="services">
        <MandalaMotif className="scatter-mandala scatter-mandala-1" />
        <MandalaMotif className="scatter-mandala scatter-mandala-2" />
        <MandalaMotif className="scatter-mandala scatter-mandala-3" />
      ...
      <SectionBand color="var(--band-blush)" motif="mandala" motifSide="left" motifTone="wine">
        <FaqSection />
      </SectionBand>

      <SectionBand color="var(--band-gold)" motif="mandala" motifSide="right" motifTone="gold">
...
function AboutPage() {
  return (
    <div className="page about-page mandala-backdrop-symmetric">
      <MandalaMotif className="page-mandala page-mandala-top" />
      <MandalaMotif className="page-mandala page-mandala-bottom" />
      <h1>About Us</h1>
      <div className="ornament"><span className="diamond" /></div>
...
function ContactPage() {
  return (
    <div className="page contact-page mandala-backdrop-side">
      <MandalaMotif className="page-mandala page-mandala-side" />
      <h1>Contact Us</h1>
      <div className="ornament"><span className="diamond" /></div>
  ...
  return (
    <div className="page category-page">
      <div className="category-hero-band">
        <ArchMotif className="category-arch-motif" />
...
function Footer() {
  return (
    <footer className="site-footer">
      <PeacockIllustration className="footer-peacock" />
...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .app-root {
        /* Warm cream base, deep burgundy + gold accents from the peacock
           logo. Page-wide mandala texture below is recolored from the
           lighter reference images (soft peach-cream + warm tan line). */
        --ivory: #FBF8F1;
        --surface: #FFFFFF;
        --wine: #8A1F38;
        --wine-dark: #4A1220;
        ...
        background-image:
          url("data:image/svg+xml;base64,"),
          radial-gradient(ellipse at 30% 25%, #F5DBB4 0%, #FBF3E1 55%, #FFFBF3 100%);
      ...
      .header-mandala {
        position: absolute; bottom: -70px; left: -60px; width: 220px;
      ...
      .band-motif { position: absolute; width: 220px; height: auto; opacity: 0.18; pointer-events: none; z-index: 0; }
      .band-motif-mandala { width: 300px; opacity: 0.22; }
      .band-motif-tone-gold { color: var(--gold); }
      .band-motif-tone-wine { color: var(--wine); }
      .band-motif-right { right: -40px; top: 50%; transform: translateY(-50%); }
      .band-motif-left { left: -40px; top: 50%; transform: translateY(-50%) scaleX(-1); }
      @media (max-width: 700px) {
        .band-motif { width: 150px; }
        .band-motif-mandala { width: 190px; }
      }
      ...
      .quote-feature-band {
        position: relative; overflow: hidden;
        background: radial-gradient(ellipse at center, #7A1B30 0%, #350B16 82%);
        padding: 90px 24px; text-align: center;
      }
      .quote-feature-mandala {
        position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
        width: 440px; color: #E8C687; opacity: 0.35; pointer-events: none;
      }
      .quote-feature-text {
      ...
      @media (max-width: 640px) {
        ...
        .quote-feature-mandala { width: 300px; }
        .quote-feature-text { font-size: 21px; }
      }

      .corner-flourish { position: absolute; width: 30px; height: 30px; color: var(--gold); opacity: 0.75; }
      ...
      /* page-level mandala backdrops (About / Contact) */
      .mandala-backdrop-symmetric, .mandala-backdrop-side { position: relative; overflow: hidden; }
      .page-mandala { position: absolute; pointer-events: none; z-index: 0; color: var(--gold); }
      .page-mandala-top { top: -40px; left: 50%; transform: translateX(-50%); width: 380px; opacity: 0.24; }
      .page-mandala-bottom { bottom: -60px; left: 50%; transform: translateX(-50%) rotate(180deg); width: 380px; opacity: 0.24; }
      .page-mandala-side { top: 50%; left: -70px; transform: translateY(-50%); width: 440px; color: var(--wine); opacity: 0.2; }
      .about-page > *, .contact-page > * { position: relative; z-index: 1; }
      @media (max-width: 700px) {
        .page-mandala-top, .page-mandala-bottom { width: 220px; }
        .page-mandala-side { width: 240px; left: -80px; }
      }

      /* category page hero band (amber gradient banner + mandap arch) */
      .category-hero-band {
        position: relative; overflow: hidden; text-align: center;
        background: linear-gradient(135deg, #D9A855 0%, #B8935A 55%, #8A6B3A 100%);
      ...
      .category-arch-motif {
        ...
        width: 220px; color: #FBF0DA; opacity: 0.22; pointer-events: none; z-index: 0;
      }

      /* scattered mini-mandalas across the services section (patchwork idea) */
      .services-section { position: relative; overflow: hidden; }
      .scatter-mandala { position: absolute; pointer-events: none; z-index: 0; }
      .scatter-mandala-1 { top: -30px; left: -40px; width: 160px; color: var(--gold); opacity: 0.12; }
      .scatter-mandala-2 { bottom: -50px; right: -30px; width: 190px; color: var(--wine); opacity: 0.1; }
      .scatter-mandala-3 { top: 40%; right: 8%; width: 100px; color: var(--gold); opacity: 0.1; }
      .services-section h2, .services-section .ornament, .services-section .services-grid { position: relative; z-index: 1; }
      @media (max-width: 700px) {
        .scatter-mandala { display: none; }
      }
