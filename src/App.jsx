...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .app-root {
        /* Palette matched to the logo card: warm tan-cream base with a
           muted gold-olive double-outlined star pattern, deep burgundy
           accent from the peacock emblem. */
        --ivory: #F3EDDE;
        --surface: #FFFFFF;
        --wine: #8A1F38;
        --wine-dark: #4A1220;
        ...
        background-image:
          url("data:image/svg+xml;base64,"),
          radial-gradient(ellipse at top, #F9F3E4 0%, var(--ivory) 65%);
      ...
      @media (max-width: 768px), (hover: none) {
        ...
        .app-root { background-attachment: scroll, scroll; }
      }
      ...
      .inspiration-section h2 { font-family: 'Playfair Display', serif; font-weight: 700; font-size: 28px; color: var(--wine-dark); }
