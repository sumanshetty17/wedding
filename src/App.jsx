...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .page-mandala-top { top: -60px; left: 50%; transform: translateX(-50%); width: 320px; opacity: 0.14; }
      .page-mandala-bottom { bottom: -80px; left: 50%; transform: translateX(-50%) rotate(180deg); width: 320px; opacity: 0.14; }
      .page-mandala-side { top: 50%; left: -100px; transform: translateY(-50%); width: 380px; color: var(--wine); opacity: 0.12; }
