...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .app-root .hero-cta:hover { background: var(--wine-dark); }
      .hero-stats {
      ...
      .app-root .inspiration-view-all {
        ...
        border: none; color: #fff; background: var(--wine); border-radius: 30px;
        padding: 12px 26px; font-size: 13.5px; font-weight: 600;
        box-shadow: 0 8px 20px rgba(214,51,108,0.3);
      }
      .app-root .inspiration-view-all:hover { background: var(--wine-dark); }
      ...
      .floral-deco {
        position: absolute; width: 220px; height: 220px; color: var(--gold);
        opacity: 0.35; pointer-events: none; z-index: 0;
      }
      .floral-deco-tl { top: -30px; left: -40px; }
      .floral-deco-br { bottom: -30px; right: -40px; transform: rotate(180deg); }
      @media (max-width: 640px) {
        .floral-deco { width: 140px; height: 140px; }
      }
      ...
      .app-root .floating-cta {
        ...
        box-shadow: 0 10px 30px rgba(214,51,108,0.4); z-index: 200;
      }
      .app-root .floating-cta:hover { background-color: var(--wine-dark); }
      ...
      .app-root .quote-submit.ready { background: linear-gradient(135deg, #E44F82, var(--wine)); box-shadow: 0 8px 22px rgba(138,31,56,0.35); }
