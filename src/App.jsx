...
function getOrCreateEditKey() {
  ...
  try {
    ...
    if (params.get("reset") === "1") {
      // Explicit recovery path: wipes only the lost/unknown private key, never
      // the site content itself, and forces a fresh key to be issued below.
      window.localStorage.removeItem(EDIT_KEY_STORAGE);
    }
