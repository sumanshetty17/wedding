  ...
  return (
    <div className="quote-modal-backdrop" onClick={onClose}>
      <div className="quote-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="quote-modal-brand">MARRIHEAVEN</div>
      </div>
    </div>
  );
}
...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .hero-cta:hover { background: var(--wine-dark); }
      .hero-stats {
      ...
      .inspiration-view-all:hover { background: var(--wine-dark); }
      ...
      /* page-level backdrops (About / Contact) — plain, clean, no texture */
      ...
      .category-card:hover { transform: translateY(-3px); box-shadow: 0 14px 32px rgba(36,21,33,0.14); }
      ...
      .service-icon {
        width: 48px; height: 48px; border-radius: 14px; background: var(--gold-light); color: var(--wine);
        display: flex; align-items: center; justify-content: center; margin: 0 auto 14px;
      }
      ...
      .floating-cta:hover { background-color: #A61E52; }
      ...
      .quote-submit.ready { background: linear-gradient(135deg, #E44F82, var(--wine)); box-shadow: 0 8px 22px rgba(138,31,56,0.35); }
