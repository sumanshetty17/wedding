...
function SectionBand({ color, motif, motifSide, children }) {
  return (
    <div className="section-band-outer">
      <WaveTop color={color} />
      <div className="section-band" style={{ backgroundColor: color }}>
        {motif === "feather" && <PeacockFeatherMotif className={"band-motif band-motif-" + (motifSide || "right")} />}
        {motif === "lotus" && <LotusMotif className={"band-motif band-motif-lotus band-motif-" + (motifSide || "right")} />}
...
function HomePage({ goToCategory }) {
  ...
  return (
    <div className="page home-page">
      ...
      <SectionBand color="var(--band-gold)" motif="feather" motifSide="right">
        <ValueProps />
      </SectionBand>
      ...
      <SectionBand color="var(--band-blush)" motif="lotus" motifSide="left">
      ...
      <SectionBand color="var(--band-blush)" motif="feather" motifSide="left">
        <FaqSection />
      </SectionBand>

      <SectionBand color="var(--band-gold)" motif="lotus" motifSide="right">
...
function GlobalStyles() {
  return (
    <style>{`
      ...
      .band-motif { position: absolute; width: 220px; height: auto; color: var(--gold); opacity: 0.16; pointer-events: none; z-index: 0; }
      .band-motif-right { right: -30px; top: 10px; }
      .band-motif-left { left: -30px; bottom: 10px; transform: scaleX(-1); }
      @media (max-width: 700px) {
        .band-motif { width: 140px; }
      }
