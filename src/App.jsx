...
function readEditRequested(editKey) {
  if (typeof window === "undefined") return true;
  try {
    // No key has ever been created on this browser yet — this is the very first
    // visit to a fresh deploy, so open the builder so the owner isn't locked out.
...
export default function App() {
  ...
  const [editKey] = useState(getOrCreateEditKey);
  const [editRequested] = useState(() => readEditRequested(editKey));
