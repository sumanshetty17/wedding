...
export default function App() {
  ...
  const [editRequested] = useState(readEditRequested);
  ...
  // A plain visit (no ?edit=1) to an already-generated site is always locked and read-only,
  // regardless of the owner's own published/editing state.
